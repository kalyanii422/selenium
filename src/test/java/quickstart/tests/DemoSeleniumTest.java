...
public class DemoSeleniumTest extends BaseTest {
	@BeforeMethod
	...
	public void GoogleSearch_automationScript() throws IOException {
		...
		logger.logInfo("Sample Test data fetched from test data file for test case 1= "
				+ testdata.getTestData("1", "Keyword"));
	}
	...
	public void GoogleSearch_Facebook() throws IOException {
		...
		logger.logInfo("Sample Test data fetched from test data file for test case 2= "
				+ testdata.getTestData("2", "Keyword"));
	...
	public void GoogleSearch_Twitter() throws IOException {
		...
		logger.logInfo("Sample Test data fetched from test data file for test case 3= "
				+ testdata.getTestData("3", "Keyword"));
	}
	...
	public void GoogleSearch_LinkedIn() throws IOException {
		...
		logger.logInfo("Sample Test data fetched from test data file for test case 4= "
				+ testdata.getTestData("4", "Keyword"));
